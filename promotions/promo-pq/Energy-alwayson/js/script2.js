...
$(document).ready(function() {
    ...
    function showPage(page) {
        ...
        if (page === 1) {
			...
			window.location.href = "http://content.fluke.com/promotions/promo-pq/Energy-alwayson/step2-powerquality.html";
          /*  $("#page2-1").show();
            $("#page2-2, #page1, #page3-1").hide();*/
        }
        else if (page === 2) {
			window.location.href = "http://content.fluke.com/promotions/promo-pq/Energy-alwayson/step2-energy.html";
...
$("#question2-1, #question2-2, #question3").hide();
