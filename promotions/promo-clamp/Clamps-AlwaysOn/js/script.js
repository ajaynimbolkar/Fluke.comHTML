...
$("#question2-1, #question2-2, #question2-3, #question3-1, #question3-2").hide();
	...
	$("#q2-1-a").on("click", function() {
	   ...
	   $(this).addClass("radiobtn-active");
	   $("#q2-1-b").removeClass("radiobtn-active");
		$("#q2-1-b").addClass("radiobtn");
	...
	$("#q2-1-b").on("click", function() {
        
		$(this).addClass("radiobtn-active");
		 $("#q2-1-a").removeClass("radiobtn-active");
		$("#q2-1-a").addClass("radiobtn");
