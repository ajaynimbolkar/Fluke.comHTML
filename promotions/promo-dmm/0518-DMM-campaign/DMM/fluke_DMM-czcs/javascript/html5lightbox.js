	...
	(function($) {
		...
		$.fn.html5lightbox = function(options) {
			...
			options = jQuery.extend({
				...
				// title
				titlecss:				"{color:#333333; font-size:16px; font-family:Verdana; overflow:hidden; white-space:nowrap;}",
				
				// error
				errorwidth:				280,
				errorheight:			48,
				errorcss:			    "{text-align:center; color:#ff0000; font-size:14px; font-family:Verdana, sans-serif;}",
			...
			*/
			function createMarkup()
			{
				...
				inst.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:999;'>" +
						...
						"<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;overflow:visible;'>" +
							"<div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:center;'>" +
								"<div id='html5-close' style='display:block;cursor:pointer;margin:0px auto; text-align:right'><img width='15' height='15' src='images/buttons/close-video.png'></div>" +
								"<div id='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;background-color:" + options.bgcolor + ";'>" + 
									"<div id='html5-loading' style='display:none;position:absolute;text-align:center;width:100%;height:100%;background:url(\"loading.gif\") no-repeat center center;'></div>" +
